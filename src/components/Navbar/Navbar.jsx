        ...
        <Box borderBottom={1} borderStyle={"solid"} borderColor={useColorModeValue("gray.200", "gray.900")}>
            ...
            >
                ...
                <Flex flex={{ base: 1 }} justify={{ base: "center", md: "start" }} align={"center"}>
                    <Link to="/">
                        <Image align="center" boxSize="35px" src={"./myntra.svg"} />
                    </Link>
                    ...
                    <Flex>
                        <Box ml={8} mr={2} cursor="pointer">
                            <Popover trigger={"hover"} placement={"bottom-start"}>
                                ...
                                <PopoverContent mt={4} justify="center" border={0} boxShadow={"xl"} rounded={"xl"} bg={popoverContentBgColor} p={4}>
                                    <ProfileBar />
                                </PopoverContent>
                            </Popover>
                        </Box>
...
for (let i = 0; i < NAV_ITEMSList.length; i++) {
    let nk = new navitem(NAV_ITEMSList[i].label, NAV_ITEMSList[i].subLabel, NAV_ITEMSList[i].children, NAV_ITEMSList[i].href);
    NAV_ITEMS.push(nk);
}
